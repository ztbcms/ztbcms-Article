    ...
    <div id="app" style="padding: 8px;" v-cloak>
        <el-card>
            <div class="filter-container">
                <el-input size="small" v-model="listQuery.title" placeholder="文章标题" style="width: 200px;" class="filter-item"></el-input>
                <el-input size="small" v-model="listQuery.group_name" placeholder="文章分类" style="width: 200px;" class="filter-item"></el-input>
                <el-input size="small" v-model="listQuery.about" placeholder="文章简介" style="width: 200px;" class="filter-item"></el-input>
            ...
            <el-table size="small"
                      ...
                      style="width: 100%;"
            >
                <el-table-column label="文章标题" align="center" width="">
                ...
                <el-table-column label="文章分类" align="center" width="">
                    <template slot-scope="{row}">
                        <div>
                            <span style="display: inline-block;width: 100px;">{{ row.group_name }}</span>
                        </div>
                    </template>
                </el-table-column>

                <el-table-column label="文章简介" align="center" width="250px;">
                    <template slot-scope="{row}">
                        <div>
                            <span style="display: inline-block;width: 100px;">{{ row.about }}</span>
                        </div>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="浏览量" align="center" width="">
                    <template slot-scope="{row}">
                        <div>
                            <span style="display: inline-block;width: 100px;">{{ row.view_num }}</span>
                        </div>
                    </template>
                </el-table-column>

                <el-table-column label="最后修改时间" align="center" width="">
                    <template slot-scope="{row}">
                        <div>
        ...
        $(document).ready(function () {
            new Vue({
                ...
                methods: {
                    ...
                    getList: function() {
                        var that = this;
                        var url = '{:U("Article/Article/articleList")}';
                    ...
                    addeditGoods: function(id){
                        var that = this;
                        var url = '{:U("Article/Article/articleDetails")}';
                        url += "&type=" + "{$_GET['type']}";
                        if(id) url += '&id=' + id;
                        layer.open({
                            type: 2,
                    ...
                    delGoods: function(id){
                        var that = this;
                        var url = '{:U("Article/Article/updatinArticle")}';
